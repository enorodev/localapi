...
export default new ProfileRenderer({
    ...
    buttons: [ { label: '+rep', url: 'https://discord.com/api/oauth2/authorize?client_id=1002031029080563732&redirect_uri=http%3A%2F%2F185.188.182.186%3A3000%2Fauth%2Fdiscord%2FrepCounter&response_type=code&scope=identify' } ]
});